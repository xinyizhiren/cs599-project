...
ResearchFlow generated this literature review on 2026-06-11 05:55 UTC. The agent searched `arxiv` sources, selected 8 core papers, extracted 16 evidence items, and linked 2 synthesis claims back to retrieved sources.
...
Retrieval-Augmented Generation (RAG) enhances large language models (LLMs) by integrating external knowledge retrieval, mitigating hallucinations and knowledge staleness. However, early RAG systems suffer from static workflows and limited adaptability, particularly for complex multi-hop queries requiring reasoning over multiple evidence pieces. Challenges include noisy or incomplete retrieval, inefficient computation, and lack of systematic evidence gap identification. Recent advances introduce agentic RAG with autonomous agents for dynamic retrieval and multi-step reasoning, iterative refinement cycles with explicit gap analysis, multi-agent synthesis for heterogeneous evidence, and structured intermediate representations like tables to reduce noise. These developments aim to improve retrieval accuracy, reasoning capability, and generation faithfulness across diverse applications.
...
- Large models outperform smaller models in query semantics and response accuracy (`llm-arxiv-2503-16581v1-1`)
- Llama3.2:3b achieves high faithfulness and relevance despite being small (`llm-arxiv-2503-16581v1-2`)
- Existing RAG methods perform unsatisfactorily in retrieving and answering multi-hop queries (`llm-arxiv-2401-15391v1-2`)
- Bridge-RAG achieves up to 1.9x faster retrieval and consistent accuracy improvements (`llm-arxiv-2603-26668v2-2`)
- FAIR-RAG achieves state-of-the-art F1-score of 0.453 on HotpotQA, 8.3 points over iterative baseline (`llm-arxiv-2510-22344v1-2`)

### Contribution

- MultiHop-RAG dataset addresses lack of benchmarking for multi-hop queries (`llm-arxiv-2401-15391v1-1`)
- Agentic RAG transcends traditional RAG by embedding autonomous AI agents (`llm-arxiv-2501-09136v4-1`)
- RAG-Check framework evaluates reliability of multi-modal RAG with RS and CS scores (`llm-arxiv-2501-03995v1-1`)

### Future Work

- Open challenges in Agentic RAG include evaluation, coordination, memory management, efficiency, and governance (`llm-arxiv-2501-09136v4-2`)

### Method

- Bridge-RAG uses an abstract bridge tree and Cuckoo Filter for efficient retrieval (`llm-arxiv-2603-26668v2-1`)
- FAIR-RAG uses Iterative Refinement Cycle with Structured Evidence Assessment (`llm-arxiv-2510-22344v1-1`)
- MASS-RAG uses multiple role-specialized agents for evidence summarization, extraction, and reasoning (`llm-arxiv-2604-18509v2-1`)
- SA-RAG uses tables as intermediate structured representation to reduce noise (`llm-arxiv-2605-24366v1-1`)

## Evidence Ledger

| Evidence ID | Paper ID | Category | Confidence | Support Text |
| --- | --- | --- | ---: | --- |
| `llm-arxiv-2503-16581v1-1` | `arxiv:2503.16581v1` | experiment | 0.65 | The findings reveal that large models consistently outperform smaller models in capturing query semantics and producing accurate, contextually grounded responses. |
| `llm-arxiv-2503-16581v1-2` | `arxiv:2503.16581v1` | experiment | 0.65 | The Llama3.2:3b model, even though it is considered small, does very well on faithfulness (4.619) and relevance (4.857), showing the promise of smaller architectures that have been well optimized. |
| `llm-arxiv-2401-15391v1-1` | `arxiv:2401.15391v1` | contribution | 0.65 | However, we find that existing RAG systems are inadequate in answering multi-hop queries... no existing RAG benchmarking dataset focuses on multi-hop queries. In this paper, we develop a novel dataset, MultiHop-RAG... |
...
| `llm-arxiv-2501-09136v4-1` | `arxiv:2501.09136v4` | contribution | 0.65 | Agentic Retrieval-Augmented Generation (Agentic RAG) transcends these limitations by embedding autonomous AI agents into the RAG pipeline. |
...
| `llm-arxiv-2603-26668v2-1` | `arxiv:2603.26668v2` | method | 0.65 | We introduce the concept of abstract to bridge query entities and document chunks... organize the abstracts into a tree structure... integrate the Cuckoo Filter in CFT-RAG, which provides O(1) entity lookup. |
| `llm-arxiv-2603-26668v2-2` | `arxiv:2603.26668v2` | experiment | 0.65 | Extensive experiments show that Bridge-RAG achieves consistent accuracy improvements across all metrics and up to 1.9x faster retrieval compared to structured RAG baselines. |
| `llm-arxiv-2510-22344v1-1` | `arxiv:2510.22344v1` | method | 0.65 | At its core is an Iterative Refinement Cycle governed by a module we term Structured Evidence Assessment (SEA). |
| `llm-arxiv-2510-22344v1-2` | `arxiv:2510.22344v1` | experiment | 0.65 | On HotpotQA, it achieves an F1-score of 0.453 -- an absolute improvement of 8.3 points over the strongest iterative baseline -- establishing a new state-of-the-art for this class of methods on these benchmarks. |
| `llm-arxiv-2501-03995v1-1` | `arxiv:2501.03995v1` | contribution | 0.65 | We propose a novel framework to evaluate the reliability of multi-modal RAG using two performance measures: (i) the relevancy score (RS)... and (ii) the correctness score (CS). |
| `llm-arxiv-2501-03995v1-2` | `arxiv:2501.03995v1` | experiment | 0.65 | Results show that both models achieve ~88% accuracy on test data... Our RS model aligns with human preferences 20% more often than CLIP in retrieval, and our CS model matches human preferences ~91% of the time. |
| `llm-arxiv-2604-18509v2-1` | `arxiv:2604.18509v2` | method | 0.65 | MASS-RAG applies distinct agents for evidence summarization, evidence extraction, and reasoning over retrieved documents, and combines their outputs through a dedicated synthesis stage to produce the final answer. |
| `llm-arxiv-2604-18509v2-2` | `arxiv:2604.18509v2` | experiment | 0.65 | Experiments on four benchmarks show that MASS-RAG consistently improves performance over strong RAG baselines, particularly in settings where relevant evidence is distributed across retrieved contexts. |
| `llm-arxiv-2605-24366v1-1` | `arxiv:2605.24366v1` | method | 0.65 | We propose Structure-aware Retrieval Augmented Generation (SA-RAG), which uses tables as an intermediate structured representation to provide a compact and controllable interface that reduces noise while preserving essential information. |
| `llm-arxiv-2605-24366v1-2` | `arxiv:2605.24366v1` | experiment | 0.65 | Experiments on two noisy real-world datasets show that SA-RAG significantly outperforms existing RAG baselines. |

## 5. Comparative Analysis

| Paper | Main Evidence | Confidence |
| --- | --- | --- |
| Investigating Retrieval-Augmented Generation in Quranic Studies: A Study of 13 Open-Source Large Language Models | Large models outperform smaller models in query semantics and response accuracy | 0.65 |
| MultiHop-RAG: Benchmarking Retrieval-Augmented Generation for Multi-Hop Queries | MultiHop-RAG dataset addresses lack of benchmarking for multi-hop queries | 0.65 |
| Agentic Retrieval-Augmented Generation: A Survey on Agentic RAG | Agentic RAG transcends traditional RAG by embedding autonomous AI agents | 0.65 |
| Bridge-RAG: An Abstract Bridge Tree Based Retrieval Augmented Generation Algorithm | Bridge-RAG uses an abstract bridge tree and Cuckoo Filter for efficient retrieval | 0.65 |
| FAIR-RAG: Faithful Adaptive Iterative Refinement for Retrieval-Augmented Generation | FAIR-RAG uses Iterative Refinement Cycle with Structured Evidence Assessment | 0.65 |
| RAG-Check: Evaluating Multimodal Retrieval Augmented Generation Performance | RAG-Check framework evaluates reliability of multi-modal RAG with RS and CS scores | 0.65 |
| MASS-RAG: Multi-Agent Synthesis Retrieval-Augmented Generation | MASS-RAG uses multiple role-specialized agents for evidence summarization, extraction, and reasoning | 0.65 |
| Structure-Aware RAG: Structured Retrieval Augmented Generation from Noisy Data for Conversational Agents | SA-RAG uses tables as intermediate structured representation to reduce noise | 0.65 |

## 6. Research Gaps

- A promising research gap is to make the literature review process auditable through claim-evidence alignment and citation checking. Evidence: `llm-arxiv-2501-09136v4-2`
